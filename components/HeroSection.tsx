	...
	return (
		<section className="flex flex-row pt-[128px] lg:pb-[182px] pb-[96px] px-8 bg-[#FBFDF8] justify-center">
			<div className="flex lg:flex-row flex-col-reverse justify-center items-center">
				<div className="lg:w-[65%] pl-5">
					<Typography variant="h1" color="black" className="lg:text-[45px] text-[36px]">
				...
				<div className="w-full h-full lg:m-0 mb-[64px]">
					<div className="lg:flex hidden"><BackgroundDesktop /> </div>
					<div className="lg:hidden flex"> <BackgroundMobile/> </div>
				</div>
			</div>
		</section>
	);
